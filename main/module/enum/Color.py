...
red_rec = [0, 160, 0, 179, 255, 200] # 빨강 본선
# red_rec = [0, 130, 90, 179, 255, 180] # 빨강 강의동
# red_rec = [0, 130, 0, 179, 255, 100] # 빨강 링 전 103
red = [0, 130, 0, 10, 255, 200] # 빨간 플래그 본선
...
blue = [90, 60, 70, 130, 220, 200] # 파랑 본선 최신. 링과 도형 둘 다 감지하는 범위
# blue = [90, 80, 70, 120, 220, 200] # 파랑 본선 진짜 최신
